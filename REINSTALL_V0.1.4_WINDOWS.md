...
2. Replace the old source directory with the extracted version 0.1.4 package so
   that `C:/fruitArchitecture/DESCRIPTION` exists.
...
When vignettes were not built during installation, use the installed static
HTML copies:
