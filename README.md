...
Version 0.1.1 is an early research release. The package implements the complete
software workflow, but metric equations and class thresholds remain explicitly
versioned while they undergo reference-dataset validation.
