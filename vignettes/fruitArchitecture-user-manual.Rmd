---
title: "fruitArchitecture User Manual"
...
vignette: >
  %\VignetteIndexEntry{fruitArchitecture User Manual}
...
```{r raw-count-analysis, eval=FALSE}
...
```{r production-permutations, eval=FALSE}
...
```{r module-plot, fig.alt="Horizontal bar chart showing the number of significant genes assigned to each fruit architecture module."}
...
```{r interface-plot, , fig.alt="Horizontal bar chart showing strict gene overlap across the three pairwise PHMIES module interfaces."}
print(
  plot(
    deg_result,
    type = "interfaces"
...
```{r null-plot, , fig.alt="Histogram of Level 3B gene counts from the permutation null model with the observed Level 3B count marked by a vertical dashed line."}
print(
  plot(
    deg_result,
    type = "null"
...
```{r custom-definition, eval=FALSE}
