...
5.  Freeze and document metric equations before treating version 0.1.0
    as a scientific release.
...
10. Release first through GitHub/Zenodo; consider CRAN or Bioconductor
    after the annotation-data distribution strategy is finalized.
